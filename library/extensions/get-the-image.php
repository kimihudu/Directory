...
function get_the_image( $args = array() ) {
	...
	echo wp_kses_post( $args['before'] . $image_html . $args['after'] );
	/* If there is a $post_thumbnail_id, do the actions associated with get_the_post_thumbnail(). */
	if ( isset( $image['post_thumbnail_id'] ) ) {
 ...
 * Get the Image link.
 *
 * @param int $deprecated 	Deprecated version.
 * @param int $deprecated_2 Deprecated version.
 * @param int $deprecated_3 Deprecated version.
 * @since 0.1.0
 * @deprecated 0.3.0
 */
 ...
 *
 * @param array $args 	Array.
 * @param bool  $image  Want to show image or want just src.
 * @since 0.1.0
 * @deprecated 0.7.0
 */
