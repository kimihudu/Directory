...
<div class="menu" id="hamburger">
	<form name="searchform_372881311" method="get" class="searchform_372881311 allinone searchform" id="mega-searchform1" action="https://planet-legal.com/" style="position:relative;">
		...
		<input type="text" onclick="tmpl_insta_search_widget( 'searchform_372881311' )" onkeypress="tmpl_insta_search_widget( 'searchform_372881311' )" value="" name="s" id="search_near-17573754111" class="searchpost placeholder" placeholder="You're not alone ..." size="100">
		<input type="hidden" name="t" value="6b4b5513eb">
