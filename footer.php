		...
		<div class="footer-wrap clearfix row">
			...
			<?php } else {
					...
					?>
						...
						<?php echo '<p class="copyright">&copy; ' . date( 'Y' ) . ' <a href="http://templatic.com/demos/directory">' . esc_html__( 'Directory 2', 'templatic' ) . '</a>. &nbsp;' . esc_html__( 'Designed by', 'templatic' ) . ' <a href="http://templatic.com" class="footer-logo"><img src="' . esc_url( get_template_directory_uri() ) . '/library/images/templatic-wordpress-themes.png" alt="' . esc_html__( 'WordPress Directory Theme', 'templatic' ) . '" /></a></p>'; ?>
					</div>
			<!-- .footer-content -->
		<?php	endif; }
