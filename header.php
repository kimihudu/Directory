   ...
   <div id="menu-secondary" class="menu-container clearfix">
      <nav role="navigation" class="wrap">
        ...
        aria-expanded="false" aria-label="Toggle navigation"><div class="animated-icon1"><span></span><span></span><span></span></div></button>
		 ...
		 <form name="searchform_37288131" method="get" class="searchform_37288131 allinone" id="mega-searchform" action="https://planet-legal.com/" style="position:relative;">
              ...
              <input type="text" onclick="tmpl_insta_search_widget( 'searchform_37288131' )" onkeypress="tmpl_insta_search_widget( 'searchform_37288131' )" value="" name="s" id="search_near-1757375411" class="searchpost placeholder" placeholder="Looking For ..." size="100">
              <input type="hidden" name="t" value="6b4b5513eb">
